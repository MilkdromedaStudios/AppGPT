...
const APP_URL = process.env.APP_URL || 'https://milkdromedastudios.github.io/AppGPT/';
...
const app = APP_URL.endsWith('/') ? APP_URL : `${APP_URL}/`;
...
await api('setMyDescription', {
  description: 'Build Telegram Mini Apps with AI. Describe an idea, generate one complete index.html, preview it, edit it, debug it, and publish it.'
});
