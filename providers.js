export const PROVIDERS = {
  openai: {
    ...
    model: "gpt-5-mini",
    hint: "OpenAI Responses-compatible chat endpoint"
  },
  openrouter: {
    name: "OpenRouter",
    kind: "openai-compatible",
    ...
    hint: "Many providers through one API"
  },
  groq: {
    name: "Groq",
    kind: "openai-compatible",
  ...
  custom: {
    ...
    model: "your-model",
    hint: "Any compatible /chat/completions endpoint"
  }
};
